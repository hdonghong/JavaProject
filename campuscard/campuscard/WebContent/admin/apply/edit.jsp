...
<HTML>
	...
	<body>
		<br>
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/adminApply?method=edit" method="post">
			<table style="width: 100%;text-align: center;">
				<TBODY>
					<tr>
						<td class="ta_01" align="center" bgColor="#afd1f3">
							<strong>编辑挂失记录</strong>
						</TD>
					</tr>
					<tr>
						<td class="ta_01">
							...
							<table border="1" id="DataGrid1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 100%; WORD-BREAK: break-all; BORDER-BOTTOM: gray 1px solid; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: #f5fafe; WORD-WRAP: break-word">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 30px" align="center" >
										<input type="hidden" name="aid" value="${apply.aid }" size="5" >
									</td>
									<td style="CURSOR: hand; HEIGHT: 30px" align="center" >
										<input name="username" type="text" value="${apply.username }" size="15" required="required" />
									</td>
									<td style="CURSOR: hand; HEIGHT: 30px" align="center" >
										<input name="adesc" type="text" value="${apply.adesc }" size="30" />
									</td>
									<td style="CURSOR: hand; HEIGHT: 30px" align="center" >
										<fmt:formatDate var="time" value="${apply.time }" pattern="yyyy-MM-dd HH:mm:ss"/>${time }
										<input type="hidden" name="time" value="${apply.time }" />
									</td>
									<td style="CURSOR: hand; HEIGHT: 30px" align="center" >
