				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav" id="menuId">
							<li id="menu_1"><a href="${pageContext.request.contextPath }/jsp/home.jsp">首页</a></li>
							<li id="menu_2"><a href="${pageContext.request.contextPath }/jsp/bill_list.jsp">消费记录</a></li>
        					<li id="menu_3"><a href="${pageContext.request.contextPath }/jsp/recharge.jsp">余额充值</a></li>
        					<li class="dropdown" id="menu_4">
					          ...
					          <ul class="dropdown-menu">
					            <li><a href="${pageContext.request.contextPath }/jsp/apply.jsp">挂失申请</a></li>
					            <li role="separator" class="divider"></li>
					            <li><a href="${pageContext.request.contextPath }/jsp/personal_info.jsp">个人信息</a></li>
					            <li role="separator" class="divider"></li>
					            <li><a href="#">了解更多</a></li>
					          </ul>
					        </li>
